...
\item \textbf{Selected Presentations:}
  \\ \null \hspace{0.2em}  -- \emph{Finite Generation of Relative Cohomology for Lie Superalgebras} (Algebra Seminar, audience: research specialists),
  \\ \null \hspace{0em} -- \emph{Statistics For Mathematicians} (SMARTS Seminar, audience: math graduate students),
