...
\headedsection
  ...
  \headedsubsection
    ...
    {Expected 2019}
    {\bodytext{Advisor: Daniel K. Nakano. Research topic: Representation theory of Lie superalgebras. Proved theorem on finite generation of relative cohomology, a continuation of a narrative in the literature.}}
    \headedsubsection
    {Statistics, MS}
    {Expected 2019}
    {\bodytext{Beginning coursework in nonparametric data analysis and applied regression analysis.}}
}
...
\headedsection
  ...
  \headedsubsection
    ...
    {2010 -- 2014}
    {\bodytext{Advisor: Farshid Hajir. Research topic: Hasse-Witt invariants of Jacobi polynomials. Used programming to investigate behavior of a family of polynomials. Motivated by work of W. Feit.}}
}
