...
\vspace{0.3in}
\noindent
\href{mailto:andrew.b.maurer@gmail.com}{\texttt{andrew.b.maurer@gmail.com}} \tabto{9.4cm} \href{http://github.com/andrewmaurer}{\texttt{github.com/andrewmaurer}} \\
(706)389-4636 \tabto{9.4cm} \href{https://linkedin.com/in/andrewbmaurer}{\texttt{linkedin.com/in/andrewbmaurer}} \\
~ \tabto{9.4cm} ~
...
% \noindent
% \begin{center}
%   \parbox{5.3in}{\emph{Motivated and independent mathematician with broad interests in technical fields seeking\\ employment in the machine learning and data science industry beginning May 2019.}}
% \end{center}
...
\roottitle{Professional Training}
...
\item \textbf{Selected Presentations:}
  \\ \null \hspace{0.2em}  -- \emph{Finite Generation of Relative Cohomology for Lie Superalgebras} (Texas A\&M Algebra Seminar, audience: research specialists),
  \\ \null \hspace{0em} -- \emph{Statistics For Mathematicians} (S.M.A.R.T.S. Seminar, audience: math graduate students),
